package net.ascend.lib.color;

import com.google.common.collect.ImmutableMap;
import net.ascend.lib.color.patterns.GradientPattern;
import net.ascend.lib.color.patterns.Pattern;
import net.ascend.lib.color.patterns.RainbowPattern;
import net.ascend.lib.color.patterns.SolidPattern;
